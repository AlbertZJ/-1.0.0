...
import { getDicts } from '@/api/organization/dictData'
import { getDictTypes } from '@/api/organization/dictType'
import buttonPermissions from '@/directive/buttonPermissions'
...
// 全局方法挂载
Vue.prototype.buttonPermissions = buttonPermissions
