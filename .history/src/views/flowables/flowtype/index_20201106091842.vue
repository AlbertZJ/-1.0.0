<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
      <el-form-item label="流程类型名称" prop="typeName">
        <el-input
    ...
    >
      ...
      <!-- <el-table-column prop="parentId" label="父类型ID" sortable width="160"></el-table-column> -->

      <el-table-column align="center" prop="typeName" label="流程类型名称"  width="160"  :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="remark" label="备注"  width="160" />
      <el-table-column align="center" prop="ancestors" label="祖级列表"  width="160"  :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="orderNum" label="显示顺序"  width="160"  :show-overflow-tooltip="true" />
        ...
        <el-row>
          ...
          <el-col v-if="form.parentId !== 0" :span="24">
            <el-form-item label="父类型ID" prop="parentId">
              <treeselect v-model="form.parentId" :options="actCnFlowTypeOptions" :normalizer="normalizer" placeholder="选择上级流程类型" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="名称" prop="deptName">
              <el-input v-model="form.typeName" placeholder="请输入流程类型名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
