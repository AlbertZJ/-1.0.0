  ...
  <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
    ...
    >
     <!-- <el-table-column prop="id" label="类型编号" sortable width="260"></el-table-column> -->
      ...
      <el-table-column prop="type_name" label="流程类型名称" sortable width="160"></el-table-column>
       <el-table-column prop="remark" label="备注" sortable width="160"></el-table-column>
      <el-table-column prop="ancestors" label="祖级列表" sortable width="160"></el-table-column>
      <el-table-column prop="order_num" label="显示顺序" sortable width="160"></el-table-column>

      <el-table-column prop="order_num" label="排序" sortable width="100"></el-table-column>
      <el-table-column prop="status" label="状态" sortable :formatter="statusFormat" width="100"></el-table-column>
        ...
        <el-row>
          <el-col :span="24" v-if="form.id !== 0">
            <el-form-item label="类型编号" prop="id">
              <treeselect v-model="form.id" :options="actCnFlowTypeOptions.id" :normalizer="normalizer" placeholder="选择上级流程类型" />
            </el-form-item>
          </el-col>
