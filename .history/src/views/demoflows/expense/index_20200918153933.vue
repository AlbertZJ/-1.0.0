  ...
  <div class="app-container">
    ...
    <!-- <div class="filter-container">
     ...
     <el-table v-loading.body="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="120px" align="center" label="报销标题">
        <template slot-scope="scope">
          <span>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column width="120px" align="center" label="报销金额（元）">
        <template slot-scope="scope">
          <span>{{ scope.row.money }}</span>
        </template>
      </el-table-column>
      <el-table-column width="120px" align="center" label="报销清单">
        <template slot-scope="scope">
...
<script>
import { getExpense, getExpenseList, addExpense, addSaveExpense, updateSaveExpense, updateExpense, deleteExpense} from '@/api/flowables/expense'
...
export default {
  ...
  methods: {
    ...
    getTask() {
      ...
      getExpenseList(this.listQuery).then(response => {
    ...
    handleUpdate(row) {
      ...
      this.find(row.modelKey)
    },
    find(modelKey){
      diagram(modelKey).then((res) => {
