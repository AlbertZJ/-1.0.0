  ...
  <div class="login-container login">
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        ...
        <el-checkbox v-model="loginForm.slidingCode" style="margin:0px 0px 25px 0px;">记住密码</el-checkbox>
...
export default {
  ...
  mounted() {
    ...
    }else if(this.loginForm.slidingCode === ''){
      this.$refs.slidingCode.focus()
    }
  },
  destroyed() {
  ...
  methods: {
     getCookie() {
      ...
      const slidingCode = Cookies.get('slidingCode')
      this.loginForm = {
        username: username === undefined ? this.loginForm.username : username,
        password: password === undefined ? this.loginForm.password : decrypt(password),
         slidingCode: slidingCode === undefined ? this.loginForm.slidingCode : slidingCode,
