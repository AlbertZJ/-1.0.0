<template>
  <div class="user-activity">
    <div class="post">
      ...
      <p>
        Lorem ipsum代表了设计师们长期以来的传统，
        排印师之类的人。有些人讨厌它，并为之争辩
        它的消亡，但其他人忽略了仇恨，因为他们创造了awesome
        工具，帮助创建填充文本的每个人培根爱好者
        致查理·辛的粉丝们。
      </p>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">昨天给你发了条信息</span>
      </div>
      <p>
        Lorem ipsum代表了设计师们长期以来的传统，
        排印师之类的人。有些人讨厌它，并为之争辩
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">张贴了4张照片- 2天前</span>
      </div>
