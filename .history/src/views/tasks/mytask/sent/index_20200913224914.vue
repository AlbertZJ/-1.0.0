  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.name" clearable size="small" placeholder="输入流程名称搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
...
const defaultForm = { id: null, name: null, isTop: '1', subCount: 0, pid: null, flowTypeSort: 999, status: 'true' }
export default {
  name: 'FlowType',
  ...
  methods: {
    ...
    changestatus(data, val) {
      this.$confirm('此操作将 "' + this.dict.label.flowType_status[val] + '" ' + data.name + '流程类型, 是否继续？', '提示', {
