<template>
 ...
 <el-select
        ...
        <!--表单渲染-->
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" width="570px">
...
let userRoles = []
let userJobs = []
const defaultForm = { id: null, username: null, nickname: null, sex: '男', email: null, enabled: 'false' }
export default {
  name: 'User',
