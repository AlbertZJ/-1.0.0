  ...
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        ...
        <div class="head-container">
          <el-tree ref="tree" :data="groupList" :props="defaultProps" :expand-on-click-node="false" :filter-node-method="filterNode" default-expand-all @node-click="handleNodeClick" />
        </div>
      </el-col>
      <!--用户数据-->
