    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
         ...
         <el-table-column align="center" prop="description" label="简介" :show-overflow-tooltip="true" />
 <el-table-column v-if="checkPermission(['Admin'])"   align="center" prop="idCard" label="身份证号" :show-overflow-tooltip="true" />
<el-table-column v-if="checkPermission(['Admin'])"   align="center" prop="wechatId" label="微信号" :show-overflow-tooltip="true" />
<el-table-column v-if="checkPermission(['Admin'])"   align="center" prop="monadId" label="社保单位" :show-overflow-tooltip="true" />
...
export default {
  ...
  data() {
    ...
    return {
      ...
      deptName: undefined, deptDatas: [], positions: [], level: 3, roles: [],
