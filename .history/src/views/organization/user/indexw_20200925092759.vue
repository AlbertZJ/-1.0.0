    ...
    <!-- <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        <div class="head-container">
          <el-input v-model="name" placeholder="请输入部门名称" clearable size="small" prefix-icon="el-icon-search" style="margin-bottom: 20px" />
        </div>
        <div class="head-container">
...
import { getAllGroups } from '@/api/organization/group'
...
//       })
this.$alert("this.queryParams.current()")
// this.addDateRange(this.queryParams, this.dateRange)
      // queryUser(this.addDateRange(this.queryParams, this.dateRange)).then(
      //   response => {

      //     console.log("data:"+response.data.records)
      //     this.userList = response.data.records
      //     this.$alert("this.userList")
      //     this.total = response.data.total
