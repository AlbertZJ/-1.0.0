<template>
  <div class="app-container">
    <el-row>
              <el-button type="info" icon="el-icon-upload2" size="mini" @click.native="handleImport()"  >导入</el-button>
             <el-button type="warning" icon="el-icon-download" size="mini" @click.native="handleExport()" >导出</el-button>
    </el-row>
    <el-row :gutter="20">
      <!--侧边部门数据-->
      <el-col :span="4" :xs="24">
...
<script>
import { crudUser,exportUser } from '@/api/organization/user'
