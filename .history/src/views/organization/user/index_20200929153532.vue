<template>
 ...
 <el-select
        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="570px">
          <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px" status-icon >
            <el-row>
        <el-col :span="12">
       ...
       <el-col :span="12">
             <el-form-item   v-if="form.id==undefined" label="密码" prop="password">
              <el-input v-model="form.password" placeholder="请输入密码" type="password" show-password   maxlength="20"  clearable />
            </el-form-item>
            </el-col>
       <el-col :span="12">
       ...
       <el-col :span="12">
            <el-form-item label="电话" prop="mobile">
              <el-input v-model.number="form.mobile" placeholder="请输入电话"   maxlength="20" />
            </el-form-item>
</el-col>
       <el-col :span="12">
...
groupQuery:{
      ...
      rules: {
        username: [
          {max: 20, required: true, message: '请输入账号', trigger: 'blur' },
        ...
        nickname: [
          {max: 2, required: true, message: '请输入用户昵称', trigger: 'blur' },
          { min: 2, max: 20, message: '长度在 2 到 20 个字符', trigger: 'blur' }
        ],
        email: [
          {max: 18,  message: '请输入邮箱地址', trigger: 'blur' },
