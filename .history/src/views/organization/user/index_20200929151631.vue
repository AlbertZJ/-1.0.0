<template>
        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="570px">
          <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
            ...
            <el-form-item label="电话" prop="mobile">
              <el-input v-model.number="form.mobile" placeholder="请输入电话" />
            </el-form-item>
 ...
 <el-form-item style="margin-bottom: 0;" label="岗位" prop="roles">
          ...
          <el-form-item  label="备注">
              <el-input v-model="form.remark" style="width:350px;" type="textarea" placeholder="请输入内容"></el-input>
            </el-form-item>
...
groupQuery:{
      ...
      rules: {
        ...
        nickname: [
          {max: 20, required: true, message: '请输入用户昵称', trigger: 'blur' },
