<template>
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        ...
        <div class="head-container">
          <el-tree ref="tree" :data="deptList" :props="defaultProps" :expand-on-click-node="false" :filter-node-method="filterNode" default-expand-all @node-click="handleNodeClick" />
        </div>
      </el-col>
      <!--用户数据-->
  ...
  color: #FFFFFF;"
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['system:user:add']" type="primary" icon="el-icon-plus" size="mini" @click="handleCreate">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['system:user:remove']" type="danger" icon="el-icon-delete" size="mini" :disabled="multiple" @click="deleteData">删除</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
        ...
        <el-table v-loading.body="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @selection-change="handleSelectionChange">
          <el-table-column v-if="showOptions" type="selection" width="50" align="center" label="ID" />
          ...
          <el-table-column align="center" label="操作" width="180" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button v-permission="['admin']" v-hasPermi="['system:user:edit']" type="primary" size="mini" icon="el-icon-edit" @click="handleUpdate(scope.row)" />
              <el-button v-hasPermi="['system:user:remove']" type="danger" size="mini" icon="el-icon-delete" @click="deleteData(scope.row.id)" />
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    /**
       ...
       */
    getDepts() {
      queryDept(this.deptQuery).then(response => {
