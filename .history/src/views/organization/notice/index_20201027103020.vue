<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column :show-overflow-tooltip="true" prop="type" label="通知类型" align="center" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="通知类型" prop="type">
              <el-input v-model="form.type" placeholder="请输入通知类型" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const defaultForm = {
  orderNum: 1, title: null,  type: null, content: null,
  status: '0',
  description: null
}
export default {
