<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column :show-overflow-tooltip="true" prop="dictLabel" label="通知标签" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="dictValue" label="通知键值" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="dictSort" label="显示顺序" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="dictType" label="通知类型" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="cssClass" label="样式属性" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="listClass" label="表格回显样式" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="isDefault" label="是否默认" align="center" />
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="65%">
      ...
      >
        <el-row>
          <el-col :span="12">
            <el-form-item label="通知标签" prop="dictLabel">
              <el-input v-model="form.dictLabel" placeholder="请输入通知标签" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="通知键值" prop="dictValue">
              <el-input v-model="form.dictValue" placeholder="请输入通知键值" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="通知类型" prop="dictType">
              <el-input v-model="form.dictType" placeholder="请输入通知类型" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="样式属性" prop="cssClass">
              <el-input v-model="form.cssClass" placeholder="请输入样式属性" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="表格回显样式" prop="listClass">
              <el-input v-model="form.listClass" placeholder="请输入表格回显样式" maxlength="20" suffix-icon="el-icon-edit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const defaultForm = {
  ...
  listClass: null, isDefault: 'Y', status: '0',
  description: null
}
export default {
  ...
  cruds() {
    return [
      CRUD({ title: '通知数据', url: '/organization/dict/data', crudMethod: { ...crudDictData },
        optShow: {
          add: true,
          edit: true,
          del: true,
  ...
  data() {
    return {
      ...
      multiple: true,
      rules: {
        dictLabel: [{ required: true, message: '通知数据名称必填', trigger: 'blur' }],
        dictType: [
