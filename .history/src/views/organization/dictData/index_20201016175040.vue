...
const defaultForm = {
  ...
  listClass: null, isDefault: null, status: "1",
  description: null
}
export default {
 ...
 this.getDicts("sys_normal_disable").then(response => {
  ...
  methods: {
    ...
    statusFormat(row, column) {
      ...
      console.log("enabledTypeOptions:",this.enabledTypeOptions)
      return this.selectDictLabel(this.enabledTypeOptions, row.status);
    },
