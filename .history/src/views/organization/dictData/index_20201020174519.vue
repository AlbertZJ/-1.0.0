<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column :show-overflow-tooltip="true" prop="dictLabel" label="字典标签"  align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="dictValue" label="字典键值"  align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="dictSort" label="显示顺序" align="center"  />
      <el-table-column :show-overflow-tooltip="true" prop="dictType" label="字典类型" align="center"  />
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="65%">
      ...
      <el-row>
        ...
        <el-form-item label="字典标签" prop="dictLabel">
          <el-input v-model="form.dictLabel" placeholder="请输入字典标签" maxlength="20" suffix-icon="el-icon-edit" clearable />
        </el-form-item>
          </el-col>
          <el-col :span="12">
        <el-form-item label="字典键值" prop="dictValue">
          <el-input v-model="form.dictValue" placeholder="请输入字典键值" maxlength="20" suffix-icon="el-icon-edit" clearable />
        </el-form-item>
          </el-col>
           <el-col :span="12">
        ...
        <el-form-item label="字典类型" prop="dictType">
          <el-input v-model="form.dictType" placeholder="请输入字典类型" maxlength="20" suffix-icon="el-icon-edit" clearable />
        </el-form-item>
          </el-col>
           <el-col :span="12">
