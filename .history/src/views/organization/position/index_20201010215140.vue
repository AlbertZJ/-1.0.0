<template>
 ...
 <el-form :model="listQuery" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
    ...
    <el-table v-loading.body="listLoading" :data="list" border fit highlight-current-row style="width: 100%"  @selection-change="crud.selectionChangeHandler" >
...
export default {
  ...
  methods: {
    ...
    /**
       ...
       */
      deletePosition(row) {
        const positionIds=row.id || this.ids
