  ...
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column :show-overflow-tooltip="true" prop="description" align="center"  label="描述" />
       ...
       <el-table-column v-if="checkPermission(['Admin'])"  :show-overflow-tooltip="true" label="删除" align="center" prop="deleted" :formatter="deletedFormat" />
