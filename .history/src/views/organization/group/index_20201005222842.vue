<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="名称" prop="label" sortable
      width="200"/>
      <el-table-column label="排序" prop="t.deptSort" sortable
      width="180"/>
      ...
      <el-table-column prop="createdTime" label="创建日期" sortable width="180">
        <template slot-scope="scope">
...
<script>
import { crudDept, changeDeptEnabled } from '@/api/organization/group'
