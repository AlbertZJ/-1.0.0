...
<script>
import {crudRole, queryRole, changeRoleEnabled, createRole, updateRole, deleteRole, getRole } from '@/api/organization/role'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '角色', url: '/organization/role', sort: 'level,asc', crudMethod: { ...crudRole }})
  },
  directives: {
    waves
  },
