<template>
 ...
 <el-row :gutter="15">
   ...
   <el-table ref="table" v-loading="crud.loading" highlight-current-row style="width: 100%;" :data="crud.data" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
      ...
      <el-table-column prop="name" align="center" label="权限字符" />
   ...
   <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title"  width="500px">
      <el-form ref="form"  :model="form" :rules="rules"  label-width="80px">
        <el-form-item label="角色代码" prop="code">
          <el-input v-model="form.code" placeholder="建议为权限字符的英文，首字母大写" maxlength="60" suffix-icon="el-icon-edit"  clearable />
        </el-form-item>
        <el-form-item label="权限字符" prop="name">
          <el-input v-model="form.name" placeholder="请输入权限字符" maxlength="40" suffix-icon="el-icon-edit" clearable />
        </el-form-item>
...
const defaultForm = { id: '', name: '', code: '', description: '', roleSort: 0}
export default {
  name: 'RoleManagement',
...
mixins: [presenter(), header(), form(defaultForm), crud()],
 ...
 // 查询参数
      ...
      rules: {
        ...
        name: [{ required: true, message: '权限字符必填', trigger: 'blur' }]
      },
      checkAll: false,
      resources: [],
