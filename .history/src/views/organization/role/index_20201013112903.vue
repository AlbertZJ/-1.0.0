     ...
     <pagination />
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="7">
        <el-card class="box-card" shadow="never">
          ...
          <el-checkbox v-model="defaultForm.deptCheckStrictly" @change="handleCheckedTreeConnect($event, 'dept')">父子联动</el-checkbox>
            ...
            ref="menu"
            node-key="id"
             :check-strictly="!defaultForm.deptCheckStrictly"
            empty-text="加载中，请稍后"
            :props="defaultProps"
          ></el-tree>
          <!-- <el-tree
...
const defaultForm = { id: '', name: '', code: '', description: '', menuCheckStrictly: true, deptCheckStrictly: true,}
export default {
  name: 'RoleManagement',
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      getRole(id).then(response => {
        this.$alert( response.data.resourceIds)
