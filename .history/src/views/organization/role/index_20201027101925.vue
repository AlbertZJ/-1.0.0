    ...
    <el-row :gutter="15">
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17" style="margin-bottom: 10px">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="table" v-loading="crud.loading" highlight-current-row style="width: 100%;" stripe :data="crud.data" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
            ...
            <el-table-column :show-overflow-tooltip="true" width="180px" align="center" label="部门">
              <template slot-scope="scope">
                <treeselect
                :disabled=true
