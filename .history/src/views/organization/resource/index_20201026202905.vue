  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
      ...
      <el-form-item label="" prop="method">
        <el-select
          @change="handleQuery"
         v-model="queryParams.method" filterable placeholder="请选择资源方法" clearable :disabled="formRead">
          <el-option
       ...
       <date-range-picker v-model="queryParams.createdTime" class="date-item" />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          v-buttonPermissions="['Admin','Developer']"
          type="danger"
          icon="el-icon-delete"
          size="mini"
          :disabled="multiple"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="菜单类型" prop="mold">
              <el-radio-group v-model="form.mold" size="mini" style="width: 178px">
          ...
          <el-col v-show="form.mold !== '2'" :span="24">
          ...
          <el-col v-show="form.mold !== '2'" :span="8">
          ...
          <el-col v-show="form.mold === '1'" :span="8">
          ...
          <el-col v-show="form.mold !== '2'" :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="排序" prop="orderNum">
              <el-input-number v-model.number="form.orderNum" :min="1" :max="999" controls-position="right" style="width: 178px;" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
