<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="name" label="资源名称" :show-overflow-tooltip="true" width="160"></el-table-column>
  ...
  methods: {
    ...
    getList() {
      ...
      queryResource(this.queryParams).then(response => {
        this.resourceList = this.handleTree(response.data.records, "id")
        this.$alert(this.resourceList)
        this.loading = false
      })
    },
    /** 转换菜单数据结构 */
