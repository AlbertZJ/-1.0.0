  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
      ...
      <el-form-item label="状态" prop="enabled">
        <el-select v-model="queryParams.enabled" placeholder="资源状态" clearable size="small">
          <el-option
    ...
    >
      <el-table-column
        ...
        width="55"
      />
      <el-table-column align="center" prop="t.name" label="资源名称" :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="t.code" label="资源编码" :show-overflow-tooltip="true" />
      <!-- <el-table-column align="center" prop="t.parentId" label="父级节点编号" :show-overflow-tooltip="true" /> -->
      <el-table-column align="center" prop="t.type" label="资源类型" :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="t.url" label="资源路径" :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="t.method" label="资源方法" :show-overflow-tooltip="true" />
      <el-table-column align="center" prop="t.description" label="资源描述" :show-overflow-tooltip="true" />
