<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="listQuery" :inline="true" label-width="68px">
      <el-form-item label="路由id" prop="code">
        <el-input
    ...
    <!--
      <el-tooltip
      content="微服务项目首先要添加的路由！" placement="bottom">
      <el-button
        class="filter-item"
    ...
    <el-dialog title="新增/修改" :visible.sync="dialogFormVisible" width="65%">
      ...
      >
        <el-form-item label="路由id" prop="routeId">
          <el-input v-model="temp.routeId" placeholder="请输入路由id" maxlength="40" suffix-icon="el-icon-edit" clearable />
        </el-form-item>

        <el-form-item label="uri路径" prop="uri">
          <el-input v-model="temp.uri" placeholder="请输入uri路径,如:lb://或http://" maxlength="60" suffix-icon="el-icon-edit" clearable />
        </el-form-item>
        <!--predicates输入框-->
        <el-form-item
